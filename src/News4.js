...
function Offercandidate() {
  ...
  return (
    <div className="new4-1">
      <div className="new4-2">
        <div className="new4-3">
          <div className="new4-4">
            <p className="new4-5">Create News</p>
            <div className="new4-6"></div>
          </div>
          <div className="new4-7">
            <div>
              ...
              <div>
              <img src={image2} onClick={changes1} className="new4-17" />
              <span style={{marginLeft:"1rem", color:"black", fontFamily:"inter", }}>Mark as important</span>
              </div>
              <div style={{ display: "flex", width: "auto" }}>
                    <label for="exampleInputEmail1" className="new4-12" style={{
                    marginTop: "5%",
                    marginLeft: "5.5%",
                    color: "black",
                  }}>
                  ...
                  <div className="txt-data" style={{width:"90%", marginLeft:"5.5%",marginTop:"2rem"}}>
