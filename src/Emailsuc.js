  ...
  return (
    <div className="email-suc">
      <Row style={{ marginTop: "1%" }}>
        <Col xd={12}>
          {" "}
          <img src={logo} className="img-fluid email-logo" />
        </Col>
      </Row>
      <Row xd={12}>
      ...
      <Row xd={12}>
        <Col style={{marginLeft:'32%'}}>
          <img src={email} className="img-fluid text-center" style={{height:'25rem',width:'35rem',alignItems:'center',justifyContent:'center'}}/>
        </Col>
      </Row>
    </div>
  );
