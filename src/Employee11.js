        ...
        <Container>
              <div onClick={showsearch} className="Employee11-1">
                <div className="Employee11-2" style={{ display: "flex" }}>
                  ...
                  <div className="Employee11-5" style={{ backgroundColor: "#ffffff" }}>
                    <Link to="/Candidate">
          ...
          >
            ...
            >
              ...
              >
                <button style={{backgroundColor: " #FAFAFA", border: "none", color:"#003666"}} className="Employee11-8">
                  General 
                </button>
              </div>
            </div>
            <div className="rec-drop" style={{ marginLeft: "-7%", position: "relative", left: "10%" }}>
              <div className="Employee11-7">
                <button style={{ backgroundColor: " #FAFAFA", color: "#003666 ", border: "none",}}className="Employee11-8">
                  Job
                </button>
              </div>
            </div>
            ...
            <div className="rec-drop"style={{ marginLeft: "1%", position: "relative", left: "20%" }}>
              <div className="Employee11-7">
                <button style={{ backgroundColor: " #FAFAFA",color: "#E0791B", border: "none", }} className="Employee11-8" >
                  Accounts settings
                </button>
              </div>
              </div>
