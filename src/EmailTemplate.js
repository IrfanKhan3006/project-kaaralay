...
function EmailTemplate() {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
      ...
      <div style={{ marginLeft: "25%", display: "flex", width: "100%" }} className="rec-select">
        <div
        ...
        <div
          className="new-jobo"
          style={{ marginLeft: "-1%", position: "relative", left: "%" }}
          onClick={clickbtn}
        >
          <div div className="user-jobo">
            <div>
              {" "}
              <img
                src={Maskjob4}
      ...
      <div className="Email-1">
        ...
        <div style={{ textAlign: "left" }} className="emaildiv">
          ...
          >
            ...
            <div className="upload100" style={{ display: "flex" }}>
              <img
                src={group1}
                className="descrip-icon-1"
                style={{ height: "20px", width: "18px" }}
              />
              <p className="upload-txt100" style={{ marginLeft: "3px" }}>
                Upload
              </p>
            </div>
          </div>
