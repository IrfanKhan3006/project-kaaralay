...
function EmailTemplate() {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
          ...
          <div onClick={showsearch} className="main-bloc">
            <div className="block" style={{ display: "flex" }}>
              ...
              <div className="bag" style={{ backgroundColor: "#ffffff" }}>
                <Link to="/candidate" style={{ textDecoration: "none", listStyle: "none" }}>
              ...
              <div className="bag" style={{ backgroundColor: "#ffffff" }}>
                <Link style={{ textDecoration: "none", listStyle: "none" }}>
                  <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ marginLeft: "6%",flexDirection: "row", display: "flex", width: "100%" }} className="rec-select20">
        <div
