      ...
      <Container>
        ...
        >
          <div className="Sec" style={{ display: "flex", width: "100%" }}>
            <img
              src={searchbar}
              className="search"
              style={{ opacity: opac, position: "relative", marginTop: "0.1%" }}
            />
        ...
        <div className="timeoff-center">
          <div className="timeoff-center-1" style={{ marginLeft: "-20%" }}>
            ...
            >
              ...
              >
                <p style={{ color: "#003666" }}>MY REQUEST</p>
              </div>
            </Link>
        ...
        >
          <div
            ...
            style={{ marginTop: "0.5%", marginBottom: "1%" }}
          >
            <div className="timeoff-head-1" style={{ paddingTop: "1.6%" }}>
              <p>Date</p>
            </div>
            <div className="timeoff-head-1" style={{ paddingTop: "1.6%" }}>
              <p>Event</p>
            ...
            <div
              className="timeoff-head-1"
              style={{ width: "15%", paddingTop: "1.6%" }}
            >
              <p>Changed By</p>
            </div>
            <div
              ...
              style={{ width: "15%", paddingTop: "1.6%" }}
            >
              <p style={{ width: "100%" }}>Change (days)</p>
            </div>
          </div>
              ...
              return (
                <div className="timeoff-data--1">
                  <div className="timeoff-data-2">
                    <p style={{ marginLeft: "4%" }}>{data.Date}</p>
                    <p style={{ marginLeft: "10%" }}>{data.Event}</p>
                    <p style={{ marginLeft: "12.5%" }}>{data.Type}</p>
                    <p style={{ marginLeft: "11.5%" }}>{data.Changed}</p>
                    <p style={{ marginLeft: "11.5%" }}>{data.Changes}</p>
                  </div>
