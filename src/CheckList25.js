      ...
      <Container>
        ...
        >
          ...
          >
            <div className="checklist__20_2_1" style={{ marginLeft: "3%" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ textDecoration: "UPPERCASE" }}>
                      Please prepare a welcome kit for the new employee:
                    </p>
                    <p style={{ marginTop: "-4%" }}>1.ID BADGE</p>
                    <p style={{ marginTop: "-6%" }}>2. CONTRACT</p>
                    <p style={{ marginTop: "-6%" }}>3 ...</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="checklist__20_2_1" style={{ marginLeft: "3%" }}>
              <div className="checklist__20_3" style={{ marginTop: "7%" }}>
                <p style={{ fontSize: "16px" }}>Prepare Workstation</p>
              </div>
              <div
                className="checklist__20_4_1"
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ textDecoration: "UPPERCASE" }}>
                      Please ensure that your new team member have a prepared
                      workstation with:
                    </p>
                    <p style={{ marginTop: "-4%" }}>1.LAPTOP</p>
                    <p style={{ marginTop: "-6%" }}>2. WORK EMAIL</p>
                    <p
                      style={{ marginTop: "-6%", textDecoration: "uppercase" }}
                    >
            ...
            <div className="checklist__20_2_1" style={{ marginLeft: "3%" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <p style={{ textDecoration: "UPPERCASE" }}>
                      Please scan both sides of your National Identification
                      Card and upload the file here.
                      <br /> Recommended format: PDF
                    </p>
                  </div>
                </div>
              </div>
