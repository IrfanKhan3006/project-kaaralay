      ...
      <Container>
        ...
        <div className="timeoff-center">
          <div className="timeoff-center-1" style={{ marginLeft: "-20%" }}>
            ...
            <div
              className="newG"
              style={{ marginLeft: "3%", width: "13rem", marginTop: "2%" }}
            >
              <Link
                to="/Employee2"
                style={{
        ...
        <div className="checklist__20" style={{marginTop:'3%'}}>
          <div className="checklist__20_1">
            <div className="checklist__20_2">
              <div className="checklist__20_3" style={{marginTop:'7%'}}>
                <p>Onboarding Templates</p>
              </div>
              <div className="checklist__20_4" style={{marginTop:'5%'}}>
                <p>Work</p>
              </div>
              <div className="checklist__20_5" style={{marginBottom:'5%',marginTop:'5%'}}>
                <Link style={{ textDecoration: "none" }}>
                  <div className="checklist__20_btn">
                    <p
                      style={{
                        paddingTop: "8px",
                        paddingLeft: "5px",
                ...
                <Link style={{ textDecoration: "none" }}>
                  <div className="checklist__20_btn" style={{width:'5rem'}}>
                    <p
                      style={{
                        paddingTop: "8px",
                        paddingLeft: "5px",
